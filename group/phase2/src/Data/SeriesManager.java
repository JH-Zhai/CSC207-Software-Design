...
public class SeriesManager {
     ...
     */
    public boolean linkMultipleEventsToSeries(DataBase dataBase, PriorityQueue<Event> events, Series series){
    ...
    public void deleteEvent(DataBase dataBase, Event event, Series series){
    ...
    public void deleteEvents(DataBase dataBase, Series series){
        int seriesId = series.getId();
        dataBase.eventAndSeries.removeIf(eventAndSeries -> eventAndSeries.getSeriesId() == seriesId);
    }
}
